...
public class LocalIdGeneratorImpl implements LocalIdGenerator {
    ...
    public String nextUniqueId() throws Exception {
        return nextUniqueId(localIdGeneratorProperties.getDataCenter(), localIdGeneratorProperties.getMachine());
    }
    ...
    public String[] nextUniqueIds(int count) throws Exception {
        return nextUniqueIds(localIdGeneratorProperties.getDataCenter(), localIdGeneratorProperties.getMachine(), count);
    }
    ...
    private SnowflakeIdGenerator getIdGenerator(long dataCenterId, long machineId) {
        ...
        if (idGenerator == null) {
            SnowflakeIdGenerator newIdGnerator = new SnowflakeIdGenerator(DEFAULT_START_TIMESTAMP, dataCenterId, machineId);
