...
public class WebRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
  ...
  private static final Map<HandlerMethod, RequestMappingInfo> HANDLER_METHOD_REQUEST_MAPPING_INFO_MAP = Maps
    .newHashMap();
  ...
  protected RequestCondition<ApiVesrsionCondition> getCustomTypeCondition(Class<?> handlerType) {
    if (versionProperties.isEnabled()) {
      ApiVersion apiVersion = (ApiVersion) AnnotationUtils
