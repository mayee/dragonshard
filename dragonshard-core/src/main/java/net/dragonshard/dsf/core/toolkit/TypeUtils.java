...
import static net.dragonshard.dsf.core.toolkit.StringPool.COMMA;
import static net.dragonshard.dsf.core.toolkit.StringPool.EMPTY;
import static net.dragonshard.dsf.core.toolkit.StringPool.NULL;
 ...
 * 修改fastjson类型转换
 *
 * @author Caratacus https://github.com/alibaba/fastjson/blob/master/src/main/java/com/alibaba/fastjson/util/TypeUtils.java
 */
