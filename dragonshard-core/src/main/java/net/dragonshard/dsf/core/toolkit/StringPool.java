 ...
 * Copy to jodd.util
 * <p>
 * Pool of <code>String</code> constants to prevent repeating of hard-coded <code>String</code>
 ...
 * performance gain of using this pool. Read: https://java.sun.com/docs/books/jls/third_edition/html/lexical.html#3.10.5
 * <ul>
 ...
 * same
 * <code>String</code> object.</li>
 * <li>Literal strings within different classes in different packages likewise represent references
 * to the same <code>String</code> object.</li>
 * <li>Strings computed by constant expressions are computed at compile time and then treated as if
 * they were literals.</li>
