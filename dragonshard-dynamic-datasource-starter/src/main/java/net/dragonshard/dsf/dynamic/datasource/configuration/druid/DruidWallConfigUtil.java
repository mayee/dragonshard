...
public final class DruidWallConfigUtil {
    ...
    public static WallConfig toWallConfig(DruidWallConfig c, DruidWallConfig g) {
        ...
        Boolean tempNoneBaseStatementAllow = c.getNoneBaseStatementAllow() == null ? g.getNoneBaseStatementAllow() : c.getNoneBaseStatementAllow();
        ...
        Boolean tempSelectIntoOutfileAllow = c.getSelectIntoOutfileAllow() == null ? g.getSelectIntoOutfileAllow() : c.getSelectIntoOutfileAllow();
        if (tempSelectIntoOutfileAllow != null && tempSelectIntoOutfileAllow) {
            wallConfig.setSelectIntoOutfileAllow(true);
        }
        Boolean tempSelectWhereAlwayTrueCheck = c.getSelectWhereAlwayTrueCheck() == null ? g.getSelectWhereAlwayTrueCheck() : c.getSelectWhereAlwayTrueCheck();
        if (tempSelectWhereAlwayTrueCheck != null && !tempSelectWhereAlwayTrueCheck) {
            wallConfig.setSelectWhereAlwayTrueCheck(false);
        }
        Boolean tempSelectHavingAlwayTrueCheck = c.getSelectHavingAlwayTrueCheck() == null ? g.getSelectHavingAlwayTrueCheck() : c.getSelectHavingAlwayTrueCheck();
        ...
        Boolean tempConditionAndAlwayTrueAllow = c.getConditionAndAlwayTrueAllow() == null ? g.getConditionAndAlwayTrueAllow() : c.getConditionAndAlwayTrueAllow();
        if (tempConditionAndAlwayTrueAllow != null && tempConditionAndAlwayTrueAllow) {
            wallConfig.setConditionAndAlwayTrueAllow(true);
        }
        Boolean tempConditionAndAlwayFalseAllow = c.getConditionAndAlwayFalseAllow() == null ? g.getConditionAndAlwayFalseAllow() : c.getConditionAndAlwayFalseAllow();
        if (tempConditionAndAlwayFalseAllow != null && tempConditionAndAlwayFalseAllow) {
            wallConfig.setConditionAndAlwayFalseAllow(true);
        }
        Boolean tempConditionDoubleConstAllow = c.getConditionDoubleConstAllow() == null ? g.getConditionDoubleConstAllow() : c.getConditionDoubleConstAllow();
        if (tempConditionDoubleConstAllow != null && tempConditionDoubleConstAllow) {
            wallConfig.setConditionDoubleConstAllow(true);
        }
        Boolean tempConditionLikeTrueAllow = c.getConditionLikeTrueAllow() == null ? g.getConditionLikeTrueAllow() : c.getConditionLikeTrueAllow();
        ...
        Boolean tempDeleteWhereAlwayTrueCheck = c.getDeleteWhereAlwayTrueCheck() == null ? g.getDeleteWhereAlwayTrueCheck() : c.getDeleteWhereAlwayTrueCheck();
        ...
        Boolean tempUpdateWhereAlayTrueCheck = c.getUpdateWhereAlayTrueCheck() == null ? g.getUpdateWhereAlayTrueCheck() : c.getUpdateWhereAlayTrueCheck();
        ...
        Boolean tempConditionOpBitwseAllow = c.getConditionOpBitwseAllow() == null ? g.getConditionOpBitwseAllow() : c.getConditionOpBitwseAllow();
        if (tempConditionOpBitwseAllow != null && !tempConditionOpBitwseAllow) {
            wallConfig.setConditionOpBitwseAllow(false);
        }
        Boolean tempCaseConditionConstAllow = c.getCaseConditionConstAllow() == null ? g.getCaseConditionConstAllow() : c.getCaseConditionConstAllow();
        if (tempCaseConditionConstAllow != null && tempCaseConditionConstAllow) {
            wallConfig.setCaseConditionConstAllow(true);
        }
        Boolean tempCompleteInsertValuesCheck = c.getCompleteInsertValuesCheck() == null ? g.getCompleteInsertValuesCheck() : c.getCompleteInsertValuesCheck();
