 ...
 */
package net.dragonshard.dsf.dynamic.datasource.configuration.hikari;
...
public class HikariCpConfig {
  ...
  public HikariConfig toHikariConfig(HikariCpConfig globalConfig) {
    ...
    Properties tempDataSourceProperties =
      dataSourceProperties == null ? globalConfig.getDataSourceProperties() : dataSourceProperties;
